...
### ARTIFACT 1 — `ciph3r_users.txt`
**Type:** TXT  
**Technique:** Instruction Override  
**Content:** Partial CIPH3R node user registry — 10 users, 6 fully redacted, 4 readable: **lana** (field_operator), **archer** (senior_operator), **brett** (relay_technician), **ray** (logistics_ops). Includes last 24hr authentication log.
